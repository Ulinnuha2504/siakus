                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                if ($lp == '1') {
                                    ...
                                    <center>
                                        <table width="90%" border="1">
                                            ...
                                            if ($ktm == 0) {
                                                ...
                                                $dt = $kon->query("SELECT*FROM penerimaan WHERE pnm_jenis='$ktm' AND pnm_tanggal BETWEEN '$aw' AND '$ak'");
                                            }
                                            $no = 1;
                                            $subtotal = 0;
                                            foreach ($dt as $d):
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><?=$d['pnm_jenis'];?></td>
                                            ...
                                            endforeach;?>
                                            <tr>
                                                <th class="text-center"colspan="5">Total Pemasukan</th>
                                    ...
                                    <div class="row mt-5"style="width: 900px; margin: 2px auto;">
                                        ...
                                        <div class="col-sm-3 text-center">Grobogan, <?= date('d F Y', strtotime($hariini)); ?> <br>Bagian Keuangan, <br><br><br><br> (<?= $_SESSION["nama"];?>)</div>
                                    </div>
                            <?php }
                            elseif ($lp == '2') {
                                if ($ktk == 0) {
                                    $dt = $kon->query("SELECT*FROM pengeluaran join pengajuan on pengeluaran.pgj_kd=pengajuan.pgj_kd join kategori_pengeluaran on pengajuan.kpr_id=kategori_pengeluaran.kpr_id WHERE pgr_tanggal BETWEEN '$aw' AND '$ak'");
                                } else {
                                    $dt = $kon->query("SELECT*FROM pengeluaran join pengajuan on pengeluaran.pgj_kd=pengajuan.pgj_kd join kategori_pengeluaran on pengajuan.kpr_id=kategori_pengeluaran.kpr_id WHERE pengajuan.kpr_id='$ktk' AND pgr_tanggal BETWEEN '$aw' AND '$ak'");
                                }
