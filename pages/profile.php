            ...
            <div class="card card-info">
              ...
              <?php foreach ($pgn as $pg) : $id=$pg['pg_id'];?>
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="Penanggung Jawab" class="col-sm-2 col-form-label">P.Jawab</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" value="<?= $pg['pg_pj'];?>" placeholder="Penanggung Jawab" disabled>
                    </div>
                  </div>
                  <div class="form-group row">
              ...
              <form action="proses.php"class="form-horizontal" method="post">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="password" class="form-control" id="inputPassword3"name="pasold" placeholder="Password lama" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-4 col-form-label">Password Baru</label>
                    <div class="col-sm-8">
                      <input type="password" class="form-control" id="pasnew"name="pasnew" placeholder="Password baru" required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="password" class="form-control" id="konpasnew"name="konpasnew" placeholder="Konfirmasi Password Baru" required>
                    </div>
                  </div>
